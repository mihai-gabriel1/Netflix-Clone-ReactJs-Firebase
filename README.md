A Netflix clone built using ReactJs, getting real time data using themoviedb Api, and using Firebase and Firestore for our backend; styling it using TailwindCSS.
